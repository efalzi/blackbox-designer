var module = angular.module('designer', ['services.blackbox']);
module.service('DesignerManager', [], function(){

});

module.controller('CanvasCtrl', ['$routeParams', 'BlackboxService', function($routeParams, BlackboxService){
    var self = this,
        bbxId = $routeParams.id;

    BlackboxService.loadJson(bbxId)
